...
<script runat="server">
    protected override void OnLoad(EventArgs e)
    {
        if (Model != null)
        {
            EnergyMonitor.Controllers.Admin.ReportsTemplate.BuildingElecDay buildingReport = new EnergyMonitor.Controllers.Admin.ReportsTemplate.BuildingElecDay();
            ...
            {
                buildingReport.ReportParameters["month"].Value = ViewBag.month;
            }
