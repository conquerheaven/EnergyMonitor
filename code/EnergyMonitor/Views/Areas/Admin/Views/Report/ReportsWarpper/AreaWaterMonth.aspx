...
<script runat="server">
    protected override void OnLoad(EventArgs e)
    {
        if (Model != null)
        {
            EnergyMonitor.Controllers.Admin.ReportsTemplate.AreaWaterMonth buildingReport = new EnergyMonitor.Controllers.Admin.ReportsTemplate.AreaWaterMonth();
            buildingReport.ReportParameters["areaId"].Value = Model;
