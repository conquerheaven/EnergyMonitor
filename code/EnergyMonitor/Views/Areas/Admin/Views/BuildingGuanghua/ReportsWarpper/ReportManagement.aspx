...
<script runat="server">
    ...
    {
        EnergyMonitor.Controllers.Admin.ReportsTemplate.ReportManagement buildingReport = new EnergyMonitor.Controllers.Admin.ReportsTemplate.ReportManagement();
        buildingReport.ReportParameters["buildingId"].Value = Model;

        buildingReport.ReportParameters["queryObjType"].Value = ViewBag.queryObjType;
        if (ViewBag.startTime != null && ViewBag.endTime != null)
        {
            buildingReport.ReportParameters["startTime"].Value = ViewBag.startTime;
            buildingReport.ReportParameters["endTime"].Value = ViewBag.endTime;            
        }
